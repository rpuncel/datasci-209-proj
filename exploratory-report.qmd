...
DATA_DIR = "data/data_centers"

centers = data_centers.copy()
timeline = pd.read_csv(f"{DATA_DIR}/data_center_timelines.csv")
...
```{python}
#| echo: false
#| label: create generated figures dir
...
See some of our intermediate artifacts outside of our report at these links:

- [Overview](https://019e8093-0783-ce2c-6773-7172db1a16e9.share.connect.posit.cloud/#)
- [Table widgets for exploring raw dataset](https://019e8093-0783-ce2c-6773-7172db1a16e9.share.connect.posit.cloud/#data-center-datasets)
- [Simple visualizations](https://019e8093-0783-ce2c-6773-7172db1a16e9.share.connect.posit.cloud/#exploratory-vis-1)
- [Single summary statistic dashboard](https://019e8093-0783-ce2c-6773-7172db1a16e9.share.connect.posit.cloud/#exploratory-story)
...
```{python}
#| echo: false
chart = alt.Chart(owner_summary.head(10)).mark_bar().encode(
...
chart.save('generated_figures/hypothesis1_view_1.png', scale_factor=2)
...
![](generated_figures/hypothesis1_view_1.png)

:::

### View 2: Site Concentration
...
chart = (site_bars + site_line).resolve_scale(y="independent").properties(
    title=alt.Title(
...
chart.save('generated_figures/hypothesis1_view_2.png', scale_factor=2)
...
![](generated_figures/hypothesis1_view_2.png)
...
### View 3: Power vs. Capital Cost

```{python}
#| echo: false
chart = alt.Chart(owner_summary.head(10)).mark_circle(opacity=0.78, stroke="white", strokeWidth=1).encode(
    x=alt.X("power_mw:Q", title="Estimated current power (MW)"),
...
chart.save('generated_figures/hypothesis1_view_3.png', scale_factor=2)
...
![](generated_figures/hypothesis1_view_3.png)
...
### View 1: Timeline With Milestones
...
chart = (growth_power + event_rules + event_labels).properties(
    title=alt.Title(
...
chart.save('generated_figures/hypothesis2_view_1.png', scale_factor=2)
...
![](generated_figures/hypothesis2_view_1.png)

:::

### View 2: Annual Additions

```{python}
#| echo: false
chart = alt.Chart(yearly[yearly["year"] >= 2021]).mark_bar().encode(
...
chart.save('generated_figures/hypothesis2_view_2.png', scale_factor=2)
...
![](generated_figures/hypothesis2_view_2.png)

:::


### View 3: Capital Pipeline

```{python}
#| echo: false
chart = alt.Chart(yearly).mark_area(line=True, opacity=0.35, color="#5f9e56").encode(
    x=alt.X("date:T", title="Year-end", axis=alt.Axis(format="%Y")),
...
chart.save('generated_figures/hypothesis2_view_3.png', scale_factor=2)
...
![](generated_figures/hypothesis2_view_3.png)
...
### View 1: Power vs. Compute Density
...
chart.save('generated_figures/hypothesis3_view_1.png', scale_factor=2)
...
![](generated_figures/hypothesis3_view_1.png)

:::

### View 2: Higher-Power, Lower-Density Sites

```{python}
#| echo: false
chart = alt.Chart(high_power_low_density).mark_bar(color="#c45a4a").encode(
...
chart.save('generated_figures/hypothesis3_view_2.png', scale_factor=2)
...
![](generated_figures/hypothesis3_view_2.png)

:::

### View 3: Continental Comparison

```{python}
#| echo: false
chart = alt.Chart(continent_summary).mark_bar().encode(
...
chart.save('generated_figures/hypothesis3_view_3.png', scale_factor=2)
...
![](generated_figures/hypothesis3_view_3.png)

:::


### View 4: U.S. State Concentration

```{python}
#| echo: false
chart = alt.Chart(state_summary_known.head(15)).mark_bar().encode(
...
chart.save('generated_figures/hypothesis3_view_4.png', scale_factor=2)
...
![](generated_figures/hypothesis3_view_4.png)
